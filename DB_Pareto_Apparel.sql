...
into #TEMP_quantile
 ...
 where trn_date >='2021-01-01' and trn_date <='2021-12-31' and sudo_tpc ='CH Childrenswear'  or sudo_tpc ='IA Intimate & Active'or sudo_tpc ='MW Menswear' or sudo_tpc = 'WW Womenswear'
...
order by Row_no
   ...
   ---add cumulative ----
  drop table [Deals_ASX_Analysis].[dbo].TEMP_cum_vol_pct_tpc
 select *,
...
into [Deals_ASX_Analysis].[dbo].DB_Pareto_apparel_TPC
from #TEMP_quantile1_tpc
