...
from (select distinct sku_no from [Deals_ASX_Analysis].[dbo].TEMP_online_trn_details2_new 
...
select *
from #TEMP_aggregation_apparel_2021
...
drop table [Deals_ASX_Analysis].[dbo].DB_aggregation_apparel_2021
 ...
 select t1.*,
 t2.sku_no_top20,
case when t2.sku_no_top20 is not null then 'Pareto Top 80' else 'Pareto Bottom 20' end as Top20_flg
